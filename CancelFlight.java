...
public class CancelFlight extends JFrame implements ActionListener {
    ...
    CancelFlight() {
        ...
        try {
            ...
            String q = "select distinct tid from bookedflight where status='booked'";
            ResultSet rest = obj.stm.executeQuery(q);
            System.out.println("Executing query: " + q);  // Debug output
            while (rest.next()) {
                System.out.println("Adding ticket ID: " + rest.getString("tid"));  // Debug output
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("AirlinesManagementSystem/Icons/f5.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            try {
                ...
                String q1 = "update bookedflight set status='" + status + "' where tid='" + tid + "'";
                String q2 = "insert into cancelflight values('" + tid + "','" + source + "','" + destination + "','" + classname + "','" + price + "','" + fcode + "','" + fname + "','" + jdate + "','" + jtime + "','" + username + "','" + name + "','" + reason + "')";
                int aa = obj3.stm.executeUpdate(q1);
                if (aa == 1) {
                    JOptionPane.showMessageDialog(null, "Your flight was successfully canceled.");
